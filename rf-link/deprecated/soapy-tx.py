...
class soapy_xmit(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Soapy Test Transmit", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Soapy Test Transmit")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "soapy_xmit")
        ...
        self._gain_range = qtgui.Range(0, 80, 2, 40, 200)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.pfb_arb_resampler_xxx_0, 0))
        ...
        self.connect((self.pfb_arb_resampler_xxx_0, 0), (self.soapy_hackrf_sink_0, 0))
    ...
    def get_xmit_rate(self):
        return self.xmit_rate

    def set_xmit_rate(self, xmit_rate):
        self.xmit_rate = xmit_rate
        self.pfb_arb_resampler_xxx_0.set_rate((self.xmit_rate / self.samp_rate))
        self.qtgui_freq_sink_x_0.set_frequency_range(self.freq, self.xmit_rate)
        self.qtgui_waterfall_sink_x_0.set_frequency_range(self.freq, self.xmit_rate)
...
def main(top_block_cls=soapy_xmit, options=None):
