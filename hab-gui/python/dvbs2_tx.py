...
class dvbs2_tx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.symbol_rate = symbol_rate = 1000e3
        ...
        self.iio_pluto_sink_0.set_bandwidth(10000000)
        ...
        168,
        4000000)
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, '/tmp/tsfifo', False, 0, 0)
        ...
        self.connect((self.fft_filter_xxx_0, 0), (self.iio_pluto_sink_0, 0))
